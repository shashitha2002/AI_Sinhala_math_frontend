        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
                ...
                <div className="bg-white dark:bg-dominant-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all">
                    ...
                    <p className="text-3xl font-bold text-gray-900 dark:text-gray-100">{dashboardData.averageScore.toFixed(1)}%</p>
                </div>
                <div className="bg-white dark:bg-dominant-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all">
                ...
                <div className="bg-white dark:bg-dominant-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all">
                    ...
                    <p className="text-3xl font-bold text-gray-900 dark:text-gray-100">{dashboardData.totalTimeSpent.toFixed(1)} {t('progress.minutes') || 'min'}</p>
                </div>
            </div>
                        ...
                        {dashboardData.mastery.map((topic, idx) => (
                            <div key={idx} className="mb-3 sm:mb-4">
                                <div className="flex justify-between mb-2">
                                    ...
                                    <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 flex-shrink-0">{topic.mastery.toFixed(2)}%</span>
                                </div>
